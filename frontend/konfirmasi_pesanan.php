...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($conn, "INSERT INTO pesanan VALUES('','$tanggal','$nama_pemesan','$alamat','$no_hp','$email','$jumlah_pesanan','$deskripsi','$produk')");
}
?>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <h1>TERIMA KASIH SUDAH BERBELANJA<br />HASIL PESANAN SUDAH TERCATAT</h1>
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <p><a href="./index.php" class="btn btn-primary btn-lg">Back to Main Menu</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
